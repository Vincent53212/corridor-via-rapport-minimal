...
**Temps Montréal-Toronto (539 km), en heures:minutes.** Horaire actuel : 5 h 18.
...
**Temps Montréal-Québec (270 km).** Horaire actuel : 3 h 22.
...
étude documente ce que les quelque 1 150 km de voies existantes du corridor riverain
peuvent donner, ainsi que les cinq obstacles qui les retiennent et le prix réglementaire
...
2. **Les passages à niveau sont l'obstacle réglementaire dominant au-dessus de
   200 km/h** : 754 des 924 passages du corridor se trouvent sur des segments dont la
   géométrie dépasserait ce seuil ; le précédent américain y exige zéro passage
   [@ecfr213-347].
...
4. **Le régime de cohabitation pèse plus que le nombre de voies.** Mesuré sur les
   horaires de VIA à géométrie neutralisée : une voie simple coûte 3 à 6 points de marge
   quand VIA est propriétaire, 27 à 33 points quand le CN l'est. Le même instrument
...
(19,9 km), Guildwood à Toronto Union (20,2 km), chacun figé à la médiane des horaires
GTFS actuels [@viarail2026gtfs] ; Ottawa, sans gare d'approche proche, est traité par une
...
Géométrie : tracé VIA reconstruit par appariement des données d'horaire GTFS sur le
...
reste sous la cible (somme des quatre trajets analysés, 1 432 km) :

| Cible | S1 | S2 | S3 |
|---|---|---|---|
| Sous 200 km/h (rectification requise pour HSR) | 620 km | 267 km | 186 km |
| Sous 160 km/h | 326 km | 122 km | 59 km |
| Sous 100 km/h (sections sévères) | présentes | résiduelles | zéro |
...
temps à l'horaire (médiane de tous les sillons du GTFS) et le temps que la géométrie
...
**Ce que le régime pèse** : sous propriétaire VIA, la voie simple ne coûte que 3 à
6 points de marge par rapport à la voie double du CN ; sous propriétaire CN, elle en
coûte 27 à 33. Le rapport est d'environ sept pour un, et il résiste aux tests de
...
rames neuves de VIA un ralentissement à 72 km/h aux passages munis de prédicteurs
(304 passages visés), déclenchant des retards de 30 à 45 minutes ; VIA a demandé le
...
l'ajout de liaisons rapides entre les deux voies (un dépassement se règle à 15 mi/h ou à
45-50 mi/h selon l'aiguillage, ce qui change tout son coût en temps) et les sections de
...
- **Jusqu'à 160 km/h : effet nul.** Le corridor s'exploite aujourd'hui en CTC à ces
  vitesses ; il n'existe pas de règle canadienne imposant un plafond du type « 79 mi/h »
  américain.
...
- **Au-delà de 200 km/h : contrôle intégral** de type ETCS. C'est le devis d'Alto, et
...
| Tronçon | Horaire actuel | S1@160 | S2@200 | S3@250 | S3@300 |
|---|---|---|---|---|---|
| Montréal-Québec (270 km) | 3 h 22 | 2 h 33 | 2 h 12 | 1 h 58 | 1 h 52 |
...
d'évitements). Tout ce que la présente étude compte (les kilomètres sous plafond, les
passages par bande, les points de marge par cellule) est l'intrant direct de cette étude,
et en borne le résultat : le temps de parcours final tombera dans les fourchettes de la
synthèse, la seule question ouverte étant où, entre la borne normative et la borne
mesurée, le régime de cohabitation laissera atterrir la marge.
