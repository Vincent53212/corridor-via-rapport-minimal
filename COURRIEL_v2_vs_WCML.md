# Brouillon de courriel — ce que la v2 fait de nouveau, et le précédent britannique

**Objet : Étude corridor v2 : des temps de parcours plutôt que des plafonds, et le précédent britannique qui valide l'ordre de grandeur**
...
5. **Les passages à niveau comptés un à un.** 924 passages sur le corridor, dont 754 sur des segments dont la géométrie dépasserait 200 km/h : c'est le vrai mur au-dessus de cette vitesse, loin devant la signalisation.

6. **La signalisation ramenée à une ligne de devis.** Rien à faire jusqu'à 160 km/h, une superposition de contrôle en cabine de 161 à 200 (précédent tarifé au Michigan), un système intégral seulement au-delà, et c'est justement le devis d'Alto.

7. **Un repère que tout le monde comprend : l'auto.** La figure de synthèse compare chaque scénario au temps routier, en fourchettes. Dès le scénario 100 pour cent précédent CN, le train bat l'auto sur Montréal-Toronto; au plafond, il fait le trajet en environ deux tiers du temps de l'auto.

**Le précédent britannique, comparable en ordre de grandeur.** Ce que l'étude propose a déjà été fait, sur une ligne comparable : la West Coast Main Line (Londres-Manchester-Glasgow), une ligne victorienne partagée avec le fret, que les Britanniques ont modernisée de 1998 à 2008 au lieu de construire une ligne neuve.
...
La leçon pour nous : un pendulaire à 200 km/h sur voie existante n'est pas une hypothèse d'étude, c'est un programme déjà réalisé, audité et documenté, sur un corridor de la même échelle que le nôtre. La mise en garde symétrique vaut aussi : le budget britannique a triplé en cours de route, en bonne partie parce que la portée n'avait pas été verrouillée au départ. C'est exactement le rôle de l'étude de circulation que le rapport recommande avant tout engagement.

Sources : National Audit Office (2006), *The Modernisation of the West Coast Main Line*, https://www.nao.org.uk/reports/the-modernisation-of-the-west-coast-main-line/ ; Wikipedia, *West Coast Main Line route modernisation* (coût final et achalandage), https://en.wikipedia.org/wiki/West_Coast_Main_Line_route_modernisation
